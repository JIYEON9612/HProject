...
<div class="updateMain" style="margin:50px;">
	<h1 style="margin-top:50px;">수정 사항을 고쳐주세요!</h1><br>
	<h3>프로젝트 정보</h3><hr>
	<form role="form" method="post" onsubmit="return pValidateForm();">
		...
		<h3 style="margin-top:100px;">프로젝트 내용</h3><hr>
			<p> <input type="text" name='pTitle' value="${partnerDto.pTitle}" style="width:100%; border: 1px solid #ddd;"></p> 		
			
			<p> <textarea name="pContent" rows="8" style="width:100%; border: 1px solid #ddd; resize: none;" >${partnerDto.pContent}</textarea></p>
			
			<p> <input type="text" name="username"  value="${partnerDto.username}"  style="width:200px; border: 1px solid #ddd;"></p>
